...
public class Constants {
    ...
    public static final String REQUEST_GET_EVENTS_LIVE_SCORE = "get_events";
    public static final String GET_PLAYER = "get_players";
    public static final String LIVE_MATCH = "match_live";
